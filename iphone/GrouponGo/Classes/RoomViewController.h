...
@interface RoomViewController : UIViewController <MTZoomWindowDelegate, RoomViewControllerDelegate, MTStatusBarOverlayDelegate, SA_OAuthTwitterControllerDelegate, UITextFieldDelegate, PTPusherDelegate, PTPusherChannelDelegate> {
	PTPusher *pusher;
